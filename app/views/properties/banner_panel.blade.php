      ...
      <div class="col-md-2 col-sm-2 col-xs-2 no-margin">
         <div class="white center">
          <div class="profileimg" style="padding:5px">
            ...
            <a href="javascript:void(0)"> {{ HTML::image('files/profiles/'.$user->profile_image, '', array('class' => 'img-responsive','id'=>'profile_image')) }}</a>
      ...
      <div class="col-md-10 col-sm-10 col-xs-10 no-margin" >
        <div class="white padding-5" style="position:relative;">
          <div style="height:200px;overflow:hidden;">
            ...
            <a class="" href="javascript:void(0)">{{ HTML::image('files/banners/'.$user->banner_image, '', array('class' => 'img-responsive','id'=>'banner_image')) }}</a>
          </div>
        </div>
      </div>
    </div>
